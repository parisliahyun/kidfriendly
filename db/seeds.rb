...
negotiate = Activity.create(vendor_id: 6, user_id: 6, name: "negotiation skills for young moguls", image_url: "http://4.bp.blogspot.com/-u6pLphFdy3o/TpuEoklgM3I/AAAAAAAAAFI/BIk9vFQhqD0/s1600/business-child-kid-computer-intern.jpg", description: "Bossy pants 101. The art of wheeling and dealing, such as, negotiation skills you can use on chore day.", vendor_id: 53)

magic = Activity.create(vendor_id: 6, user_id: 6, name: "magic!", image_url: "http://www.clker.com/cliparts/8/a/0/a/1195424618541325975johnny_automatic_linking_rings.svg.med.png", description: "Learn magic tricks from Houdini's great, great, great grandson's neighbor's cousin, Jeff!", vendor_id: 53)
